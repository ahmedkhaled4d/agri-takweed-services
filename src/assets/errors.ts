export const ErrorMessage = {
  ...
  INVALID_AGE: "Invalid Age Must be positive!",
  ...
  NO_USER_FOUND_IN_DB: "No user found",
  NO_CROP_FOUND: "No crop found!",
  NO_VARIETY_FOUND: "No variety found!",
  CROP_NOT_ESTIMATABLE: "Crop Cannot be estimated! Not ready"
};
...
export const ErrorCode = {
  ...
  INDEX_OUT_OF_BOUND: "index.outofbound",
  YIELD_ESTIMATION_DOWN: "yield.estimation.down",
  INVALID_AGE: "age.invalid",
  ...
  NO_RESOURCE_FOUND: "resource.notfound",
  INVALID_PARAM: "param.invalid",
  INVALID_INDEX: "index.invalid",
  NO_GPX_POINTS: "gpx.missing.points",
  NO_CROP_FOUND: "crop.missing.db",
  NO_VARIETY_FOUND: "variety.missing",
  CROP_NOT_ESTIMATABLE: "crop.not.estimatable"
};
